...
// Create the width and height based on the svg margins and parameters to fit chart group within the canvas
var width = svgWidth - margin.left - margin.right;
var height = svgHeight - margin.top - margin.bottom;

// Create the canvas to append the SVG group that contains the states data
// attribute the canvas width and height calling the variables predifined.
...
function successHandle(statesData) {
  ...
  // Loop through the data and pass args data
